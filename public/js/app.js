...
function updateCart(shoe) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/update-cart', shoe).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var shoe = JSON.parse(btn.dataset.shoe);
...
var msg = document.querySelector('#success-alert');
if (msg) {
  setTimeout(function () {
    msg.remove();
  }, 3000);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshop_easy"] = self["webpackChunkshop_easy"] || [];
